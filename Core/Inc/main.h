...
#define Encoder_Esq_Pin GPIO_PIN_4
#define Encoder_Esq_GPIO_Port GPIOB
#define Encoder_Dir_Pin GPIO_PIN_5
...
void enviarVelocidade(int velocidadeEsquerda, int velocidadeDireita);
