...
#define Ultra_Tr_Eco_TIM_Pin GPIO_PIN_0
#define Ultra_Tr_Eco_TIM_GPIO_Port GPIOB
#define Ultra_Es_Eco_TIM_Pin GPIO_PIN_1
#define Ultra_Es_Eco_TIM_GPIO_Port GPIOB
...
#define Ultra_Rot_Eco_TIM_Pin GPIO_PIN_14
#define Ultra_Rot_Eco_TIM_GPIO_Port GPIOB
#define IR4_AD_Pin GPIO_PIN_15
#define IR4_AD_GPIO_Port GPIOB
#define Ultra_Di_Eco_TIM_Pin GPIO_PIN_6
#define Ultra_Di_Eco_TIM_GPIO_Port GPIOC
...
#define Colisao_Pin GPIO_PIN_2
#define Colisao_GPIO_Port GPIOD
