...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(Ultra_Fr_Eco_TIM_GPIO_Port, Ultra_Fr_Eco_TIM_Pin);

    HAL_GPIO_DeInit(GPIOB, Ultra_Tr_Eco_TIM_Pin|Ultra_Es_Eco_TIM_Pin);

    HAL_GPIO_DeInit(Ultra_Di_Eco_TIM_GPIO_Port, Ultra_Di_Eco_TIM_Pin);
  ...
  /* USER CODE END TIM15_MspDeInit 0 */
    ...
    PB14     ------> TIM15_CH1
    */
    HAL_GPIO_DeInit(Ultra_Rot_Eco_TIM_GPIO_Port, Ultra_Rot_Eco_TIM_Pin);
